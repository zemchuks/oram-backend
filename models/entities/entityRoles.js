...
Schema.statics.createEntityRoles = async function () {
...
Schema.statics.updateEntityRoles = async function (data, id) {
...
Schema.statics.deleteEntityRoles = async function (id) {
    return await this.findOneAndUpdate({
        _id: id
    }, {
        $set: {
...
Schema.statics.getEntityRolesFromArrayOfIds = async function (ids) {
...
module.exports = mongoose.model("EntityRoles", Schema)